  ...
  return (
    <>
      ...
      <button
        ...
        aria-label={i("a11y.searchTrigger")}
      >
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh]">
          ...
          />
          <div role="dialog" aria-modal="true" aria-label={i("a11y.searchDialog")} className="relative z-10 w-full max-w-lg mx-4 rounded-2xl bg-surface-secondary border border-border shadow-2xl overflow-hidden">
            {/* Search input */}
            <div className="flex items-center gap-3 px-4 py-3 border-b border-border">
              ...
              />
              {query && (
                <button onClick={() => setQuery("")} className="p-1 hover:bg-surface-tertiary rounded" aria-label={i("a11y.clearSearch")}>
