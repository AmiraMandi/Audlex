...
export function LanguageSwitcher({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div role="listbox" aria-label="Seleccionar idioma" className="absolute right-0 top-full mt-1 w-36 rounded-lg border border-border bg-surface shadow-lg py-1 z-50">
          {locales.map((locale) => (
            <button
              key={locale}
