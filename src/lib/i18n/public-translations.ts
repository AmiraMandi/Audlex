...
const publicTranslations: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "auth.reset.sent.prefix": "Si existe una cuenta con",
    "auth.reset.sent.suffix": ", recibirás un enlace para restablecer tu contraseña. Revisa también la carpeta de spam.",
  ...
  en: {
    ...
    "auth.reset.sent.prefix": "If an account exists with",
    "auth.reset.sent.suffix": ", you'll receive a link to reset your password. Check your spam folder too.",
