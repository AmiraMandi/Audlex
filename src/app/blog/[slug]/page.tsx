...
const articles: Record<string, {
  ...
  "plataforma-comision-europea-ai-act": {
    title: "La Comisión Europea lanza una plataforma centralizada para el cumplimiento del EU AI Act",
    date: "2026-03-17",
    readTime: "7 min",
    category: "Actualidad",
    categoryColor: "bg-emerald-500/10 text-emerald-600 border-emerald-500/20",
    content: [
      { type: "p", text: "La Comisión Europea ha dado un paso significativo en la implementación del EU AI Act con el lanzamiento de una nueva plataforma digital que centraliza recursos clave para todos los actores del ecosistema de inteligencia artificial. Esta herramienta, accesible desde el AI Act Service Desk, está diseñada para facilitar la comprensión y el cumplimiento de la normativa europea de IA." },
      { type: "h2", text: "¿Qué es la plataforma del AI Act Service Desk?" },
      { type: "p", text: "Se trata de un portal oficial de la Comisión Europea que reúne en un solo lugar las herramientas y recursos necesarios para que empresas, desarrolladores, consultoras y organismos públicos puedan navegar las obligaciones del Reglamento (UE) 2024/1689. La plataforma incluye tres recursos principales que cubren desde la autoevaluación hasta la exploración del texto legal." },
      { type: "h2", text: "Los 3 recursos clave de la plataforma" },
      { type: "h3", text: "1. Compliance Checker — Autoevaluación de obligaciones" },
      { type: "p", text: "El Compliance Checker permite realizar una autoevaluación preliminar para identificar qué obligaciones del AI Act podrían aplicar a un sistema o modelo de IA concreto, según su perfil de riesgo. Es una herramienta especialmente útil para empresas que están empezando su proceso de compliance y necesitan una primera orientación sobre su situación." },
      { type: "callout", text: "Importante: El Compliance Checker proporciona una orientación preliminar. Para un análisis detallado con documentación completa y clasificación precisa, herramientas especializadas como Audlex ofrecen un proceso guiado mucho más exhaustivo." },
      { type: "h3", text: "2. National Resources Explorer — Recursos por país" },
      { type: "p", text: "Este módulo proporciona acceso a iniciativas y materiales relevantes relacionados con la implementación del AI Act en los diferentes Estados miembros de la UE. Cada país está desarrollando su propio enfoque regulatorio y esta herramienta permite consultar los avances nacionales." },
      { type: "p", text: "Para España, esto es particularmente relevante dado que la AESIA (Agencia Española de Supervisión de la Inteligencia Artificial) ya está operativa y ha publicado 16 guías prácticas de implementación." },
      { type: "h3", text: "3. EU AI Act Explorer — Navegación del texto legal" },
      { type: "p", text: "El AI Act Explorer permite navegar el texto completo del reglamento de forma intuitiva, facilitando la búsqueda rápida de artículos, definiciones y requisitos específicos. Ya no es necesario buscar en PDFs de cientos de páginas: la herramienta permite encontrar rápidamente las disposiciones relevantes para cada caso de uso." },
      { type: "h2", text: "¿Por qué es importante esta plataforma ahora?" },
      { type: "p", text: "El timing del lanzamiento no es casual. Nos encontramos en una fase crítica de implementación del AI Act:" },
      { type: "ul", text: ["Febrero 2025: Las prácticas de IA prohibidas (Art. 5) ya están en vigor", "Agosto 2025: Entran en vigor las obligaciones para modelos de IA de propósito general (GPAI)", "Agosto 2026: Fecha límite para sistemas de alto riesgo del Anexo III", "Las empresas necesitan actuar ahora para llegar preparadas a los plazos"] },
      { type: "h2", text: "¿Qué significa para las empresas españolas?" },
      { type: "p", text: "Para las empresas en España, esta plataforma representa un recurso complementario valioso, pero no sustituye la necesidad de realizar un proceso de compliance propio. La autoevaluación del Compliance Checker es un buen punto de partida, pero las organizaciones necesitan ir más allá:" },
      { type: "ul", text: ["Inventariar todos sus sistemas de IA (incluidos los de terceros como ChatGPT, Salesforce Einstein, etc.)", "Clasificar cada sistema según los criterios exactos del Anexo III", "Generar la documentación técnica obligatoria para sistemas de alto riesgo", "Implementar protocolos de supervisión humana", "Establecer un sistema de monitorización continua"] },
      { type: "h2", text: "Plataforma de la CE vs. herramientas de compliance especializadas" },
      { type: "p", text: "La plataforma de la Comisión Europea es una excelente fuente de información y orientación general. Sin embargo, existe una diferencia fundamental entre consultar recursos informativos y ejecutar el proceso de compliance:" },
      { type: "ul", text: ["La plataforma CE orienta sobre qué obligaciones podrían aplicar → Audlex ejecuta el proceso completo de clasificación, documentación y monitorización", "El Compliance Checker ofrece una evaluación preliminar → Audlex genera toda la documentación técnica obligatoria automáticamente", "El AI Act Explorer ayuda a buscar artículos → Audlex traduce cada artículo en acciones concretas y checklists verificables"] },
      { type: "h2", text: "El momento de actuar es ahora" },
      { type: "p", text: "Con cada mes que pasa, los plazos del AI Act se acercan más. El lanzamiento de esta plataforma por parte de la Comisión Europea envía un mensaje claro: la implementación va en serio y se espera que las organizaciones se preparen activamente." },
      { type: "p", text: "Ya no hay excusa para no empezar. Los recursos están disponibles, las guías publicadas, y las herramientas listas. La pregunta no es si tu empresa necesita cumplir con el AI Act, sino cuándo va a empezar a prepararse." },
      { type: "callout", text: "¿Quieres pasar de la información a la acción? Audlex te permite clasificar tu primer sistema de IA gratis y generar toda la documentación de compliance automáticamente. Empieza hoy y llega preparado a agosto de 2026." },
    ],
  },
